; optiRAM Setup Script
; Requires InnoSetup 6  https://jrsoftware.org/isinfo.php
;
; Compile:
;   iscc installer\optiRAM.iss          (run from project root)
;
; Prerequisites:
...
SetupIconFile=..\src\optiRAM\Resources\app.ico
...
Name: "startonboot";  Description: "Start optiRAM &automatically when Windows starts"
...
Type: filesandordirs; Name: "{userappdata}\optiRAM"
